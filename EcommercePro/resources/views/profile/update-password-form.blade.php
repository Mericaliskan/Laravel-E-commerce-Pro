<x-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        {{ __('Hesabınızın güvende kalması için uzun, rastgele bir şifre oluşturun.') }}
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-label for="current_password" value="{{ __('Eski Şifre') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('Yeni Şifre Tekrarı') }}" />
